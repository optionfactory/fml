...
describe('associativity', () => {
    ...
    ast("ternary is right-associative", "1 ? 2 : 3 ? 4 : 5", '{"type":"Symbol(ternary)","cond":{"type":"Symbol(literal)","value":1},"ifTrue":{"type":"Symbol(literal)","value":2},"ifFalse":{"type":"Symbol(ternary)","cond":{"type":"Symbol(literal)","value":3},"ifTrue":{"type":"Symbol(literal)","value":4},"ifFalse":{"type":"Symbol(literal)","value":5}}}');    
    ...
    ast("null-coalescence is right-associative", "1 ?? 2 ?? 3", '{"type":"Symbol(null-coalescence)","lhs":{"type":"Symbol(literal)","value":1},"rhs":{"type":"Symbol(null-coalescence)","lhs":{"type":"Symbol(literal)","value":2},"rhs":{"type":"Symbol(literal)","value":3}}}');    
